...
awful.immerseOL(flyingPoints)

local groundPoints = {
    { x = -9.064600944519043,  y = 1775.9498291015625, z = 241.838623046875 },
...
awful.immerseOL(groundPoints)

local points = flyingPoints
...
local function distanceToClosestPoint(critter)
    ...
    for index, value in ipairs(points) do
        local dist = critter.distanceTo(value.x, value.y, value.z)
